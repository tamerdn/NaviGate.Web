        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScacCode = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Shipments_Firms_FirmId",
                        column: x => x.FirmId,
                        principalTable: "Firms",
                        principalColumn: "FirmId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Shipments_Ports_ArrivalPortId",
                        column: x => x.ArrivalPortId,
                        principalTable: "Ports",
                        principalColumn: "PortId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Shipments_Ports_DeparturePortId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AiAlertId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShipmentId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AiAlerts", x => x.AiAlertId);
                    table.ForeignKey(
                        name: "FK_AiAlerts_Shipments_ShipmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipmentTrackings", x => x.ShipmentTrackingId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipments_ArrivalPortId",
                table: "Shipments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipments_DeparturePortId",
                table: "Shipments",
                column: "DeparturePortId");

            migrationBuilder.CreateIndex(
                name: "IX_Shipments_FirmId",
                table: "Shipments",
                column: "FirmId");
